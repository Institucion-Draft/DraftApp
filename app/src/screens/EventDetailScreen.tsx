        ...
        <View style={styles.delegateBackdrop}>
          <View style={styles.delegateSheet}>
            ...
            {loadingDelegateCandidates ? (
              <ActivityIndicator size="small" color={colors.accent} style={styles.delegateLoading} />
...
const createStyles = (c: ThemeColors) =>
  StyleSheet.create({
    ...
    cancelledBannerTitle: { color: c.status.error.text, fontWeight: '700', fontSize: 14, textAlign: 'center' },
    cancelledBannerMeta: { color: c.status.error.text, fontWeight: '600', fontSize: 12, textAlign: 'center', marginTop: 6 },
    header: { alignItems: 'center', padding: 24, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: c.divider },
    avatar: { width: 84, height: 84, borderRadius: 16, backgroundColor: c.backgroundAlt, marginBottom: 10 },
    avatarPh: { justifyContent: 'center', alignItems: 'center', backgroundColor: c.status.info.subtle },
    avatarTxt: { fontSize: 34, fontWeight: '700', color: c.status.info.text },
    title: { fontSize: 22, fontWeight: '700', color: c.text, marginBottom: 6, textAlign: 'center' },
    meta: { color: c.textSecondary, fontSize: 14, marginBottom: 4 },
    link: { color: c.accent },
    tiebreakNotice: {
      marginHorizontal: 24,
      marginTop: 4,
    ...
    tiebreakNoticeTitle: { fontSize: 15, fontWeight: '700', color: c.status.warning.text, marginBottom: 6 },
    tiebreakNoticeBody: { fontSize: 14, color: c.status.warning.text, lineHeight: 20 },
    tiebreakNoticeSecondary: { fontSize: 12, color: c.status.warning.text, marginTop: 2 },
    tiebreakNoticeBtn: {
      marginTop: 12,
    ...
    tiebreakNoticeBtnTxt: { color: c.status.warning.onSolid, fontSize: 15, fontWeight: '600' },
    tiebreakVsRow: {
      flexDirection: 'row',
      marginTop: 12,
      gap: 6,
    ...
    secondaryBtnTxt: { color: c.accent, fontSize: 15, fontWeight: '600' },
    disabledBtn: { opacity: 0.5 },
    disabledHint: { color: c.textSecondary, fontSize: 12, marginTop: -4, marginBottom: 10 },
    concludeBtn: {
      backgroundColor: 'transparent',
      borderWidth: 1,
      borderColor: c.status.error.solid,
      borderRadius: 8,
      paddingVertical: 10,
      alignItems: 'center' as const,
      marginBottom: 4,
    },
    concludeTxt: { color: c.status.error.solid, fontSize: 14, fontWeight: '500' as const },
    dangerBtn: {
      backgroundColor: c.status.error.subtle,
      borderWidth: 1,
    ...
    prodecPillLabel: { fontSize: 18, fontWeight: '800', color: c.text },
    ...
    participantName: { fontSize: 15, fontWeight: '700', color: c.text, marginBottom: 2 },
    ...
    championName: { fontSize: 18, fontWeight: '700', color: c.text },
    championBadge: {
      paddingHorizontal: 8,
      paddingVertical: 3,
      borderRadius: 999,
    ...
    polemicaBadgeText: { fontSize: 11, fontWeight: '700', color: c.status.error.text },
    fragmentadaBadge: {
      paddingHorizontal: 8,
      paddingVertical: 3,
      borderRadius: 999,
    ...
    fragmentadaBadgeText: { fontSize: 11, fontWeight: '700', color: c.status.info.text },
    recognitionBadge: {
      paddingHorizontal: 8,
      paddingVertical: 3,
      borderRadius: 999,
    ...
    recognitionBadgeText: { fontSize: 11, fontWeight: '700', color: c.status.info.text },
    leftEventChip: {
      paddingHorizontal: 8,
      paddingVertical: 3,
      borderRadius: 999,
    ...
    leftEventChipText: { fontSize: 11, fontWeight: '700', color: c.textBody },
    metaSmall: { fontSize: 12, color: c.textSecondary },
    inlineRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
    registeredTxt: { color: c.status.success.text, fontSize: 14, fontWeight: '600' },
    smallDangerBtn: {
      borderWidth: 1,
      borderColor: c.status.error.border,
      backgroundColor: c.status.error.subtle,
    ...
    smallDangerTxt: { color: c.status.error.text, fontSize: 12, fontWeight: '700' },
    placeholderBtn: {
      borderWidth: 1,
      borderColor: c.borderStrong,
      borderRadius: 8,
    ...
    placeholderTxt: { color: c.textBody, fontSize: 14, fontWeight: '600' },
    placeholderSub: { color: c.textMuted, fontSize: 12, marginTop: 4, fontWeight: '500' },
    ...
    delegateTitle: { fontSize: 18, fontWeight: '700', color: c.text, marginBottom: 4 },
    delegateSubtitle: { fontSize: 13, color: c.textSecondary, marginBottom: 14 },
    ...
    delegateName: { fontSize: 15, fontWeight: '600', color: c.text, flexShrink: 1 },
    ...
    delegateBtnTxt: { color: c.organizer.text, fontSize: 15, fontWeight: '600' },
    ...
    postaBadge: {
      ...
      height: 16,
      borderRadius: 8,
      backgroundColor: c.organizer.solid,
      borderWidth: 1.5,
      borderColor: c.organizer.onSolid,
      alignItems: 'center',
      justifyContent: 'center',
    },
    postaBadgeText: { color: c.organizer.onSolid, fontSize: 9, fontWeight: '700', lineHeight: 11 },
    delegateCancelBtn: { paddingVertical: 12, alignItems: 'center', marginTop: 6 },
    delegateCancelTxt: { color: c.textSecondary, fontSize: 14, fontWeight: '600' },
  });
