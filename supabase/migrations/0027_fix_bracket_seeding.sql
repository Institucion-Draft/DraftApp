-- 0027_fix_bracket_seeding.sql
-- Fix: el seeding del bracket debe ordenar por winrate de partidas individuales descendente, no por participant_id.
...
begin
  ...
  -- 4 líderes: bracket seeded por winrate de partidas individuales DESCENDENTE
