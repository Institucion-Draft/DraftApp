-- 0036_recalc_after_round_generation.sql
-- generate_swiss_round debe recalcular tiebreakers al final, después de asignar el bye.
-- Sino, los puntos del bye de la ronda recién generada no se reflejan hasta el próximo recalc.
...
begin
  ...
  -- Recalcular tiebreakers después de asignar el bye y los pairings de esta ronda.
