-- 0058_exclude_2hg_from_individual_stats.sql
-- En eventos two_headed_giant cada gigante comparte una fila de event_participants,
-- por lo que solo el user_id del miembro A queda registrado. Incluir esos pairings/matches
-- contamina v_head_to_head_stats y v_player_streaks con resultados que no corresponden
-- a la historia individual de cada jugador.
-- Fix: agregar de.event_type <> 'two_headed_giant' en cada JOIN con draft_events de ambas views.

-- ── 1. v_head_to_head_stats ──────────────────────────────────────────────────
