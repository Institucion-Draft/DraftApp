-- 0063_is_official.sql
-- Agrega is_official a draft_events y excluye eventos no oficiales de las vistas de estadísticas.

alter table public.draft_events add column if not exists is_official boolean not null default true;
